...
export class RestaurantDetailPage extends PageBase {
    ...
    showDirection() {
        this.navCtrl.push(MapRoutePage, { locations: this.restaurant.locations, type: "eat" });
    }
                ...
                data => {
                    if (data.Code === 200) {
                        ...
                        data.Result.forEach(element => {
                            if(element.LOCATION_ID == this.restaurant.id && element.LOCATION_TYPE == 'RESTAURANT') {
